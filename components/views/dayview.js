import fullFormConfig from "../forms/formUtils.js";
import FormSetup from "../forms/setForm.js";
import getEntryOptionModal from "../menus/entryOptions.js";

import { Day } from "../../factory/entries.js";

import calcTime, { formatTime } from "../../utilities/timeutils.js";
...
import handleOverlap, {
  ...
  resetOriginalBox,
} from "../../utilities/dragutils.js";

import { getClosest, placePopup } from "../../utilities/helpers.js";
...
export default function setDayView(context, store, datepickerContext) {
  ...
  function configHeader() {
    [dvHeaderDayNumber, dvHeaderDayOfWeek].forEach((el) => {
      // el.innerText = "";
    });
    ...
    document.querySelector(".dv-gmt").textContent = `GMT+00`;
