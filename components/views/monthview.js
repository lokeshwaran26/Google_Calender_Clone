// rendering
import setViews from "../../config/setViews.js";
import setSidebarDatepicker from "../menus/sidebarDatepicker.js";
...
// Box query
import MonthBoxQuery from "../../factory/queries.js";
...
import { setStylingForEvent } from "../../utilities/dragutils.js";
...
export default function setMonthView(context, store, datepickerContext) {
  ...
  function createCellHeader(cell, day) {
    const daynumberAndMonth = day.getDate() ;
